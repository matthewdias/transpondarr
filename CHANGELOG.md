...
Add a film from AniList and it is searched on its title and release year, graded
against your quality profile, grabbed, and filed into a Movies library of its
own. Episodes keep going exactly where they went before, and gain a flat filing
option for the scanner configurations that prefer it. The REST resource `series`
is also now `titles`, which API clients need to know about.
