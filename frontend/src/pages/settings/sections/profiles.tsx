  ...
  return (
    ...
    >
      <button
        ...
        className="cursor-grab touch-none rounded p-0.5 text-faint outline-none focus-visible:ring-[3px] focus-visible:ring-ring active:cursor-grabbing"
        aria-label="Reorder"
        {...attributes}
        {...listeners}
      >
    ...
    >
      ...
      {list.map((p) => (
        <button
          ...
          className="flex w-full items-center gap-3 rounded-md border bg-card px-3 py-2.5 text-left transition-colors hover:bg-panel-2/60 focus-visible:ring-[3px] focus-visible:ring-ring focus-visible:outline-none"
        >
