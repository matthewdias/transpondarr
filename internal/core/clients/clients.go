// Package clients contains the live download/indexer/library clients behind a
...
// so a swap applies on the next request or poll.
//
...
// Registry is the swappable set of the four pluggable clients.
